...
public abstract class CodeBuilder {
	...
	public String getCode(int seq) {
		...
		sb.append(StringUtils.fillPrefix(
				Long.toString(seq % CodeGenerateConfig.NO_CIRCLE), "0",
    ...
    public static String getCode(int seq,String PREFFIX) {
        ...
        return new StringBuilder(PREFFIX)  //前缀
                        .append(DateUtils.getTodayString())  //日期 8位
                        .append(StringUtils.fillPrefix(Long.toString(seq % CodeGenerateConfig.NO_CIRCLE), "0", CodeGenerateConfig.NO_CIRCLE_LENGTH)) //填充0
                        .toString();
    }
