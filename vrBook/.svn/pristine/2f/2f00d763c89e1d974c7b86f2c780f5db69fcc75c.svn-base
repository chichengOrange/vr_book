...
/**
 * A data object class directly models database table <tt>vr_functions_point_log</tt>.
 *
 ...
 *
 * @author guangdong.li
 * @version $Id: FunctionsPointLogDO.java,v 1.0 2013/10/29 07:34:20 guangdong.li Exp $
 */
public class FunctionsPointLogDO extends BaseDO {
	...
	/**
	 * This property corresponds to db column <tt>OPERATION_TYPE</tt>.
	 */
	private String operationType;

	/**
	 * This property corresponds to db column <tt>OPERATION_COUNT</tt>.
	 */
	private int operationCount;

	/**
	 * This property corresponds to db column <tt>POSITION</tt>.
	 */
    ...
    /**
     * Getter method for property <tt>operationCount</tt>.
     *
     * @return property value of operationCount
     */
	...
	/**
	 * Setter method for property <tt>operationCount</tt>.
	 * 
	 * @param operationCount value to be assigned to property operationCount
     */
