...
/**
 * A data object class directly models database table <tt>vr_model_log</tt>.
 *
 ...
 *
 * @author guangdong.li
 * @version $Id: ModelLogDO.java,v 1.0 2013/10/29 07:34:20 guangdong.li Exp $
 */
public class ModelLogDO extends BaseDO {
