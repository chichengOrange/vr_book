...
public interface BookDAO {
	 ...
	 *  <p>
	 *  The sql statement for this operation is <br>
	 *  <tt>select ID, BOOK_ID, BOOK_NAME, BOOK_IMG, BOOK_AUTHOR, BOOK_PUBLISH, BOOK_SIZE, BOOK_HEAT, NOW_NETWORK, DOWNLOAD_URL, DOWNLOAD_COUNT, CAN_DOWNLOAD, SORT, PRICE, DISTRIBUTOR, GMT_CREATE, GMT_MODIFIED from vr_book where (BOOK_ID = ?)</tt>
	 *
	 *	@param bookId
	 *	@return BookDO
	 *	@throws DataAccessException
