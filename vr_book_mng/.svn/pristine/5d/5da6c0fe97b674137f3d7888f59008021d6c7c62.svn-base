...
public class IbatisOntimeDAO extends SqlMapClientDaoSupport implements OntimeDAO {
	 ...
	 *  <tt>select * from vr_ontime where (1 = 1)</tt>
	 *
	 *	@return List<Map<String,Object>>
	 *	@throws DataAccessException
	 */	 
    public  List<Map<String,Object>>   selectOutInterface() throws DataAccessException {


        return getSqlMapClientTemplate().queryForList("MS-ONTIME-SELECT-OUT-INTERFACE", null);
	 ...
	 *	@throws DataAccessException
	 */	 
    public  List<Map<String,Object>>   selectOntime() throws DataAccessException {


        return getSqlMapClientTemplate().queryForList("MS-ONTIME-SELECT-ONTIME", null);
