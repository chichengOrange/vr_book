...
/**
 * A data object class directly models database table <tt>vr_user</tt>.
 *
...
public class UserDO extends BaseDO {
	...
	/**
	 * This property corresponds to db column <tt>PSW</tt>.
	 */
	private String psw;
    ...
    /**
     * Getter method for property <tt>psw</tt>.
     *
     * @return property value of psw
     */
	...
	/**
	 * Setter method for property <tt>psw</tt>.
	 * 
	 * @param psw value to be assigned to property psw
     */
