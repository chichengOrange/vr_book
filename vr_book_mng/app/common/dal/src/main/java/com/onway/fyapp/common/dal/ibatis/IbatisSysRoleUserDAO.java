...
public class IbatisSysRoleUserDAO extends SqlMapClientDaoSupport implements SysRoleUserDAO {
	 ...
	 *  <p>
	 *  The sql statement for this operation is <br>
	 *  <tt>insert into sys_role_user(USER_ID,USERNAME,PASSWORD,ROLE_ID,CREATER,GMT_CREATE) values (?, ?, ?, ?, ?, ?)</tt>
	 *
	 *	@param sysRoleUser
	 *	@return int
	 *	@throws DataAccessException
	 ...
	 *  <p>
	 *  The sql statement for this operation is <br>
	 *  <tt>update sys_role_user set USERNAME=?, ROLE_ID=?, MODIFIER=?, GMT_MODIFIED=? where (id = ?)</tt>
	 *
	 *	@param username
	 *	@param roleId
	 *	@param modifier
	 ...
	 *	@throws DataAccessException
	 */	 
    public  int   updateadminuser(String username, String roleId, String modifier, Date gmtModified, int id) throws DataAccessException {
        Map<String,Object> param = new HashMap<String,Object>();
	 ...
	 *  <p>
	 *  The sql statement for this operation is <br>
	 *  <tt>update sys_role_user set PASSWORD=? where (USER_ID = ?)</tt>
	 *
	 *	@param password
	 *	@param userId
	 *	@return int
	 *	@throws DataAccessException
	 */	 
    public  int   updatepassword(String password, String userId) throws DataAccessException {
        Map<String,Object> param = new HashMap<String,Object>();
	 ...
	 *  <p>
	 *  The sql statement for this operation is <br>
	 *  <tt>update sys_role_user set DEL_FLG=?, MODIFIER=?, GMT_MODIFIED=? where (ID = ?)</tt>
	 *
	 *	@param delFlg
	 *	@param modifier
	 *	@param gmtModified
	 ...
	 *	@throws DataAccessException
	 */	 
    public  int   deleteSysUserById(String delFlg, String modifier, Date gmtModified, int id) throws DataAccessException {
        Map<String,Object> param = new HashMap<String,Object>();
        ...
        return getSqlMapClientTemplate().update("MS-SYS-ROLE-USER-DELETE-SYS-USER-BY-ID", param);
    }
	 ...
	 *	@throws DataAccessException
	 */	 
    public  int   resetpassword(String password, String userId) throws DataAccessException {
        Map<String,Object> param = new HashMap<String,Object>();

        param.put("password", password);
        param.put("userId", userId);

        return getSqlMapClientTemplate().update("MS-SYS-ROLE-USER-RESETPASSWORD", param);
    }
