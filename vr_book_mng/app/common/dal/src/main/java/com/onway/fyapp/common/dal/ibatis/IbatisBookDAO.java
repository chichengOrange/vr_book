 ...
 * <tt>com.onway.fyapp.common.dal.daointerface.BookDAO</tt>.
 *
...
public class IbatisBookDAO extends SqlMapClientDaoSupport implements BookDAO {
	 ...
	 * @throws DataAccessException
	 */
	public List<BookDO> selectAllBook(String bookId, String bookName, String bookPublish, String bookAuthor,
			String distributor, Integer offset, Integer limit) throws DataAccessException {
	 ...
	 * @throws DataAccessException
	 */
	public int selectallbookcount(String bookId, String bookName, String bookPublish, String bookAuthor,
			String distributor) throws DataAccessException {
	...
	/**
	 * Insert one <tt>BookDO</tt> object to DB table <tt>vr_book</tt>, return
	 * primary key
	 *
	 * <p>
	 * The sql statement for this operation is <br>
	 ...
	 * @throws DataAccessException
	 */
	public int updatBookNoImg(String bookName, String bookAuthor, String bookPublish, String bookSize,
			String downloadUrl, int canDownload, Money price, int sort, int downloadCount, int id)
			throws DataAccessException {
		Map<String, Object> param = new HashMap<String, Object>();
	 ...
	 * @throws DataAccessException
	 */
	public int updatBookNofile(String bookName, String bookAuthor, String bookPublish, String bookImg, int canDownload,
			Money price, int sort, int downloadCount, int id) throws DataAccessException {
		Map<String, Object> param = new HashMap<String, Object>();
	 ...
	 * @throws DataAccessException
	 */
	public int updatBookNoTwo(String bookName, String bookAuthor, String bookPublish, int canDownload, Money price,
			int sort, int downloadCount, int id) throws DataAccessException {
		Map<String, Object> param = new HashMap<String, Object>();
	...
	@Override
	public int updatBookIos(String iosSize, String downloadIosUrl, int id) throws DataAccessException {
		// TODO Auto-generated method stub
		Map<String, Object> param = new HashMap<String, Object>();

		param.put("iosSize", new Integer(iosSize));
		param.put("downloadIosUrl", downloadIosUrl);
		param.put("id", new Integer(id));

		return getSqlMapClientTemplate().update("MS-BOOK-UPDAT-IOS", param);
	}
	 ...
	 * @throws DataAccessException
	 */
	public int updatBook(String bookName, String bookAuthor, String bookPublish, String bookImg, String bookSize,
			String downloadUrl, int canDownload, Money price, int sort, int downloadCount, int id)
			throws DataAccessException {
		Map<String, Object> param = new HashMap<String, Object>();
