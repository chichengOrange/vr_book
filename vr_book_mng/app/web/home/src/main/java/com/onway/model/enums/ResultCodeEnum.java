...
public enum ResultCodeEnum implements EnumBase {
    ...
    /**三方没结果码返回置结果为失败*/
    NOT_RESULT_CODE_MAP_FAIL("NOT_RESULT_CODE_MAP_FAIL", "三方没结果码返回置结果为失败"),
    ...
    /**用户认证失败,请联系客服!*/
    USER_CERTIFY_FAIL("USER_CERTIFY_FAIL", "用户认证失败,用户名身份证号码不匹配!"),
    ...
    /**支付失败,请稍后重试*/
    BIZ_DEPOSIT_FAIL("BIZ_DEPOSIT_FAIL", "支付失败,请稍后再试或联系盈盈客服400-870-5800"),

    /**充值回查失败,请稍后重试*/
    BIZ_DEPOSIT_QUERY_FAIL("BIZ_DEPOSIT_FAIL", "充值回查失败,请稍后再试或联系盈盈客服400-870-5800"),
    ...
    /**验证失败,请稍后重试*/
    BIZ_AUTH_FAIL("BIZ_AUTH_FAIL", "验证失败,请稍后再试或联系盈盈客服400-870-5800"), ;
